# Contributing to AladdinSDK Plugin Builder

Thank you for your interest in contributing to AladdinSDK Plugin Builder! We welcome all contributions, big or small. To ensure that contributions are properly tracked and attributed, we require that all contributors sign off on their work using the Developer Certificate of Origin (DCO).
